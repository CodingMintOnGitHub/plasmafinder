...
{
    public class AddBloodViewModel : MvxViewModel
    {
        ...
        public AddBloodViewModel(IMvxNavigationService mvxNavigationService, IMvxMessenger mvxMessenger)
        {
        ...
        private async Task SubmitCommand_Handler(string param)
        {
            ...
            //    Price = 0,
            //    Type = (int)Resource_Type.Blood, //blood
            ...
            //};
             ...
             await _mvxNavigationService.Navigate<AddOxygenViewModel>();
        }
