...
{
    public class AddOxygenViewModel : MvxViewModel
    {
        ...
        public AddOxygenViewModel(IMvxNavigationService mvxNavigationService, IMvxMessenger mvxMessenger)
        {
        ...
        private async Task SubmitCommand_Handler(string param)
        {
            ...
            //    Price = 0,
            //    Type = (int)Resource_Type.Oxygen, //oxygen
