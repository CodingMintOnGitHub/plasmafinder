...
{
    public class FoodDonationListViewModel : MvxViewModel
    {
        private readonly IMvxNavigationService _mvxNavigationService;
        private readonly MvxSubscriptionToken _token;
        private readonly IMvxMessenger _mvxMessenger;

        public FoodDonationListViewModel(IMvxNavigationService mvxNavigationService, IMvxMessenger mvxMessenger)
        {
